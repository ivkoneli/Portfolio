...
export const PROJECT_ORIGINS = {
  ...
  'shader-pipelines': { col: 16, row: 17 },  // right arm — DOWN (1st)
  domineering:        { col: 21, row: 6 },   // right arm — UP   (2nd)
  tasking:            { col: 26, row: 17 },  // right arm — DOWN (3rd)
  'pokemon-go':       { col: 31, row: 6 },   // right arm — UP   (4th)
}
...
function buildLayout() {
  ...
  // Spine: about plaza (north) → hub → bridge (south), all on col 13.
  vRoad(13, 4, 22)
  ...
  // Right arm: one long road, four 3-tile spurs zigzagging off it.
  hRoad(13, 32, 13)
  vRoad(17, 14, 16)  // shader      — DOWN spur
